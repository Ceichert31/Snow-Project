...
public class TopDownFeature : ScriptableRendererFeature
{
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        {
            var colorDescription = renderingData.cameraData.cameraTargetDescriptor;
            colorDescription.depthBufferBits = 0;
